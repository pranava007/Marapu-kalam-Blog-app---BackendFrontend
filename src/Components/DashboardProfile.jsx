...
const DashboardProfile = () => {
  ...
  const [imageFileUploadError,setFileUploadError] = useState(null);
  ...
  const uploadImage = async()=>{
    ...
    uploadTask.on(
      ...
      (snapshot)=>{
        ...
        setImageFileUploadProgress(progress.toFixed(0)); //10.4854
      },
      (error)=>{
        setFileUploadError('Could not upload the image (File size must be less then 2MB)');
